              ...
              <div class="sidebar">
                  ...
                  <nav class="mt-2">
                      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                          ...
                          <li class="nav-item has-treeview menu-open"><a href="{{route('home')}}" class="nav-link active"><i
                          ...
                          <li class="nav-item has-treeview"><a href="#" class="nav-link"><i
                              ...
                              <ul class="nav nav-treeview">
                                  ...
                                  <li class="nav-item">
                                      <a href="{{route('modifier_utilisateur')}}" class="nav-link">
                                          <p>Modifier un utilisateur </p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="{{route('supprimer_utilisateur')}}" class="nav-link">
          ...
          <div class="content-wrapper">
              ...
              <section class="content">
                @yield('content')
                  ...
                  <script src="dist/js/adminlte.js"></script><!-- AdminLTE dashboard demo(This is only for demo purposes) -->
